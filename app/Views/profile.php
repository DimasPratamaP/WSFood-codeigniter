	...
	<div class="row">
		<div class="col-md-3 ">
		     <div class="list-group ">
              ...
              <a href="#" class="list-group-item list-group-item-action">Account security</a>              
            </div> 
		</div>
		<div class="col-md-9">
		    <div class="card">
		                ...
		                <div class="col-md-12">
		                    <form>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <input id="wmail" name="email" placeholder="email" class="form-control here" type="email" value="<?= $users['email'] ?>">
                                </div>
                              </div>
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                  <textarea id="publicinfo" name="alamat" cols="40" rows="4" class="form-control"><?= $users['alamat'] ?></textarea>
                                </div>
                              </div>
                              <div class="form-group row">
